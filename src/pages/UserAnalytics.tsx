          ...
          icon={
            ...
            >
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M12.75 0H2.25C1.2875 0 0.5 0.7875 0.5 1.75V26.25C0.5 27.2125 1.2875 28 2.25 28H19.75C20.7125 28 21.5 27.2125 21.5 26.25V8.75L12.75 0ZM18 24.5H4V3.5H11V10.5H18V24.5Z"
                fill="#F5B849"
              />
            </svg>
          }
